    ...
    <div className={styles.container}>
      ...
      <main className="flex flex-col h-screen py-20">
        ...
        <section className='w-8/12 mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4 my-10 border-gray-200 border-2 border-r-4 p-4'>

            { allBooks.data.map((book) => (
                <div className='flex flex-col bg-gray-200 gap-y-2' key={book.id}>
                  <div className='w-full h-64 bg-gray-400'>Image</div>
                  <div id="bookInfo" className='px-4 py-2'>
